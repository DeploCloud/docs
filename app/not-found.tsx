...
export default function NotFound() {
  return (
    <div className="relative flex min-h-screen flex-1 flex-col items-center justify-center gap-6 px-6 py-24 text-center">
      ...
      <Link
        href="/"
        className="cursor-pointer rounded-full bg-white px-5 py-2.5 text-black transition duration-300 focus:outline-hidden active:opacity-100 lg:hover:opacity-80"
      >
        Back to docs
      </Link>
    </div>
