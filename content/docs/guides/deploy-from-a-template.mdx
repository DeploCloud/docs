...
- Give it your own hostname in [Domains](/guides/domains-and-https).
- Its data is in [volumes](/guides/persistent-storage), which survive redeploys.
- Back it up like anything else: [Backups and restore](/guides/backups-and-restore).
- Read what it prints in [Logs](/guides/logs).
...
<Cards>
  ...
  <Card icon={<Database className="text-blue-400" />} title="Databases" description="For Postgres and friends, a managed database is usually a better fit" href="/guides/databases" />
  <Card icon={<SlidersHorizontal className="text-blue-400" />} title="Environment variables" description="How generated values and overrides work" href="/guides/environment-variables" />
</Cards>
