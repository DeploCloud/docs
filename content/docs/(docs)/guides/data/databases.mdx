...
<Cards>
  ...
  <Card icon={<Terminal className="text-blue-400" />} title="Console and files" description="A one-time-acknowledged engine shell" href="/guides/observability/console-and-files" />
