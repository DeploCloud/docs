...
/**
 * Same as fumadocs-ui's own ViewOptionsPopover, minus "Open in Scira AI" (not
 * relevant here). Fumadocs doesn't expose a way to filter its built-in item
 * list, so this is a local copy of the same items/icons instead.
 */
