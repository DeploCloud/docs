...
- **Do not put a database's data in a Bind unless you mean it.** A managed [database](/guides/databases) already has its own managed volume.
...
- **A Bind row will not save** - you do not hold the permission. Ask an administrator, and see [Host access and privileges](/advanced/host-access-and-privileges).
...
<Cards>
  <Card icon={<Database className="text-blue-400" />} title="Databases" description="Storage a managed database already handles for you" href="/guides/databases" />
  <Card icon={<Archive className="text-blue-400" />} title="Backups and restore" description="What gets copied off the volume" href="/guides/backups-and-restore" />
  <Card icon={<Terminal className="text-blue-400" />} title="Console and files" description="Browsing what is actually there" href="/guides/console-and-files" />
  <Card icon={<Lock className="text-blue-400" />} title="Host access and privileges" description="Who can add a Bind mount" href="/advanced/host-access-and-privileges" />
</Cards>
