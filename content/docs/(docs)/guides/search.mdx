...
**Every row is a page.** Pressing **Enter** opens it and closes the palette -
on an app or a database that is its Overview. The palette never redeploys,
starts or stops anything: those verbs stay on the page that owns them, behind
their own confirmation.

You only ever see what you are allowed to see. The palette hides what your
Capabilities do not cover, and the server checks again when you open it.
