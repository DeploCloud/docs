...
| Size             | **2 GB of RAM and 20 GB free on `/`** is the comfortable floor, and 2 vCPU if you build on this machine. Below 2 GB the installer warns and builds get tight; **below 8 GB free it refuses**, because Docker images alone do not fit. |
