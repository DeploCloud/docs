...
Optionally set a **Host port** to expose it outside the server. This needs the `canExposePorts` grant, and you should think twice: an app on the same Deplo instance does not need it.
